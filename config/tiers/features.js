        ...
        return [
            {
                ...
                features: [
                    ...
                    { emoji: '🎉', name: 'Ceremony of the Month', tier: 'starter', teacherExplain: 'When a new month begins, the ceremony picks its style automatically: Nursery and Pre-Junior open Growth Festival (garden, Parade of Blooms, Golden Bloom — no public ranks). Every other valid league opens Classic Arena (Team Quest class ranks, then Prodigy of the Month; Co-Prodigy allowed). Tabs pulse until you run it. Hall of Prodigies archives monthly crowns. The Grand Guild Ceremony in June is a different, year-end house crowning. 🎉🏆', why: 'Creates an emotional peak without mixing daily heroes with monthly prodigies.' },
                ]
            },
            {
                id: 'identity',
