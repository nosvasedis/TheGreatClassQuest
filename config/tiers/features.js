        ...
        return [
            ...
            },
            {
                ...
                features: [
                    ...
                    { emoji: '🌟', name: 'AI Seasonal Shop', tier: 'elite', key: 'eliteAI', teacherExplain: "Every month, tap Restock in the Mystic Market. AI writes 15 seasonal treasures with pictures in the background — the stall fills as they arrive. Complete items stay put; a second Restock only weaves the missing pictures. Students love discovering what's new each month! 🛒✨", why: 'Fresh monthly items keep students excited to check the shop and earn more gold every single lesson.' },
                ]
            },
        ];
    }
