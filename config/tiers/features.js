...
export const FEATURE_DEFINITIONS = {
    ...
    calendar: {
        ...
        tier: 'Pro',
        teacherExplain: 'Quest Calendar shows lesson days, cancellations, and Quest Events. Open a day and use the Quest Event tab: choose a card for 2× Star Day or Reason Bonus Day (the app applies them on Award Stars), or a Special Quest you run in the room — Vocabulary Vault, Grammar Guardians, The Unbroken Chain, The Scribe’s Sketch, or Five-Sentence Saga. Cancel a class or add a one-time lesson from the Day Planner. School-wide holiday ranges are set in the School Office (Secretary). You can still mark a single unexpected closure as a school holiday from the Day Planner. 📋✨',
    ...
    heroProgression: {
        ...
        tier: 'Pro',
        teacherExplain: "Open the Hero Class ceremony from Manage Students (shield on an unsorted child) or Edit → Hero Path → Choose / Change Hero Class. The child previews a class, then Swear this Path. Leave them unassigned for No Class. They level by earning stars in that class's matching virtue (not generic XP). A Patron levels by giving Hero's Boon — the receiver still gets +0.5 stars; the Patron does not buy rank with Gold. Each level offers one of two Skill Tree branches (extra Gold, bonus stars, or help for classmates/guildmates). Matching awards also grant +10 Gold. They keep their Hero Class from year to year. Each school year they may change it twice; the second change locks the path until the next school year. ⚔️🧙",
    ...
    secretaryAccess: {
        ...
        tier: 'Elite',
        teacherExplain: "The School Office (Secretary) owns this year's classes, new students, student placement, the school year, holiday ranges, school-wide grading defaults, and family messages. Finishing a year archives last year's Gold so Treasury starts at 0; guild houses stay. Teachers still run the lesson; the office keeps the calendar honest, adds new heroes, and seats returning ones. Open it from the header shield when your school has Secretary access. 🏛️🗂️",
        ...
        return [
            {
                ...
                features: [
                    ...
                    { emoji: '💰', name: 'Mystic Market', tier: 'starter', teacherExplain: 'Its own tab. Students spend Gold (not stars — rank never drops when they shop) on 15 Legendary Artifacts with fixed prices. Gold is this school year\'s purse: finishing the year archives last year\'s Gold so Treasury starts at 0. Two legendary buys per student per month. On Elite, the monthly stall, Festival Stall, Restock, and Familiar eggs appear. You do not set those prices. Reigning Hero of the Day gets 25% off the seasonal shelf. 🛒✨', why: 'Teaches delayed gratification without selling leaderboard rank.' },
                    { emoji: '🎁', name: "Hero's Boon", tier: 'starter', teacherExplain: "A classmate spends 15 Gold to give +0.5 stars (free all month with Compassion Token). Max 4 gifts per class per day. The receiver must be in the bottom 3 monthly stars or in a tie group. No self-gift; cannot gift the same classmate twice in a row. Grey hearts mean not eligible. Distinct from Teacher Boon and from the Hero of the Day's automatic +1. On Pro, a Patron levels from giving this gift. 🎁💫", why: 'Teaches generosity with fairness rules the class can see.' },
                    ...
                    { emoji: '🎉', name: 'Ceremony of the Month', tier: 'starter', teacherExplain: 'When a new school month begins, the ceremony picks its style automatically: Nursery and Pre-Junior open Growth Festival (garden, Parade of Blooms, Golden Bloom — no public ranks). Every other valid league opens Classic Arena (Team Quest class ranks, then Prodigy of the Month; Co-Prodigy allowed). August has no ceremony — schools are closed then — so September does not show an August badge. The first ritual of a year is October for September. Home glows until you run it. Hall of Prodigies archives monthly crowns. The Grand Guild Ceremony in June is a different, year-end house crowning. 🎉🏆', why: 'Creates an emotional peak without mixing daily heroes with monthly prodigies.' },
                ]
            },
            {
                id: 'identity',
            ...
            },
            {
                ...
                features: [
                    ...
                    { emoji: '👑', name: 'Hero of the Day', tier: 'pro', key: 'adventureLog', teacherExplain: "Crowned automatically when you Log Today's Adventure — you do not pick the name by hand. Mask of the Protagonist wins if pending; otherwise a fair rotation among present students. Perks: +1 on their first award that day (labelled Includes Hero's Boon), 25% off seasonal Market, and this year's legend discounts (Rising / Golden / Mythic). Last year's crowns stay in last year's Hall of Heroes. Distinct from Prodigy of the Month. 👑📓", why: 'A daily spotlight with real perks — without stealing the monthly crown.' },
            ...
            },
            {
                ...
                features: [
                    ...
                    { emoji: '🏛️', name: 'School Office', tier: 'elite', key: 'secretaryAccess', teacherExplain: FEATURE_DEFINITIONS.secretaryAccess.teacherExplain, why: 'One person owns classes, new students, student placement, holidays, and the school year so every teacher calendar matches.' },
                ]
            },
            {
                id: 'creative',
    ...
    return [
        {
            ...
            features: [
                ...
                { emoji: '🛒', name: 'Mystic Market', tier: 'starter', studentExplain: 'Spend Gold (not stars!) in the Mystic Market. 🛒✨ Legendary Artifacts with special powers are always there. On Elite, new seasonal treasures appear each month, a Festival Stall for holidays, plus Familiar eggs. Buying things never lowers your star rank. Each school year starts with a fresh purse.', why: 'Every item you buy is proof of how much you\'ve participated and grown! 🏆' },
        ...
        },
        {
            ...
            features: [
                { emoji: '⚔️', name: 'Your Hero Class', tier: 'pro', studentExplain: 'Who is your hero? ⚔️ Choose your Hero Class — Guardian, Sage, Paladin, Artificer, Scholar, Weaver, Nomad, or Patron — and level up by earning stars in your specialty. Each level unlocks new skills on your Skill Tree, making your hero more powerful. Your adventure is YOUR adventure! 🌟', why: 'Your class defines your strengths and gives you a unique identity in the Quest! 🌟' },
        ...
        },
        {
            ...
            features: [
                { emoji: '🎉', name: 'Ceremony of the Month', tier: 'starter', studentExplain: "When a new school month begins, your class holds the Ceremony of the Month! 🎉🏆 (August is holiday — no ceremony then.) Nursery and Pre-Junior watch Growth Festival — a garden celebration with a Golden Bloom. Older leagues watch Classic Arena: classes are ranked on Team Quest, then one student becomes Prodigy of the Month (sometimes a Co-Prodigy shares the crown). Guild Champions and the Grand Guild Ceremony are a different, house story.", why: 'Your hard work deserves a real celebration when the school month closes! 🌟' },
                ...
                { emoji: '📅', name: 'Quest Events', tier: 'pro', studentExplain: "Your teacher plans Quest Events on the calendar! 📅🎊 A 2× Star Day or Reason Bonus Day makes stars extra that lesson. Special Quests — Vocabulary Vault, Grammar Guardians, The Unbroken Chain, The Scribe’s Sketch, Five-Sentence Saga — are one-lesson class challenges with a progress bar you can see on the projector.", why: "There's always something exciting to look forward to in the Quest! 🌟" },
