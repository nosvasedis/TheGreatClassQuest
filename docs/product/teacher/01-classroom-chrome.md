...
Give the room a living atmosphere (time, weather, a daily line of wisdom) and one-tap access to the class, the Game Guide, the projector, and Teacher Settings — without leaving the lesson.

## What you see (desktop header)
...
The wallpaper is not a blank poster. It tells the room how long things last — but only when those clocks are real:
...
- Floating **student clouds** on Award Stars
- **Guild anthems** (karaoke-timed lyrics) in Guild Hall
- **Ceremony music** and drumrolls
- **Familiar** animations beside avatars

## Mobile teacher layout
...
| Starter | Pro | Elite |
|---------|-----|-------|
| Header, clock, Follow today’s schedule, Guide, Projector wallpaper, weather skies, Sky Theater | Guild, log, and Hero Path cards on the wallpaper when those features are on | AI Director cards (facts, jokes, riddles). School Office shield when Secretary is on |
